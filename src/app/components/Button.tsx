...
const baseStyle =
	"inline-flex text-sm bg-primary-600 rounded-lg py-2 px-3 hover:bg-primary-700 active:bg-primary-800 transition-all text-primary-50";
...
const Button: React.FC<ButtonProps> = ({ children, onClick, className }) => {
	return (
		<button
			className={clsx(baseStyle, skeumorphicStyle, className)}
			onClick={onClick}
		>
			{children}
		</button>
